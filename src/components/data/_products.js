...
const products = [
  ...
  },
  {
    title: "Dell Inspiron",
    price: "ARG: " + 149.999,
    detail: "Los equipos Dell se destacan por ofrecer soluciones reales para cada una de las necesidades. Ya sea para conectarte, entretenerte, trabajar o colaborar de manera online, podrás hacerlo de forma segura desde cualquier lugar y en cualquier momento.",
    img: "https://http2.mlstatic.com/D_NQ_NP_805951-MLA50865156506_072022-O.webp",
  },
  {
    title: "Apple MacBook Pro",
    price: 1587,
    detail: "El chip M1 de Apple redefine al Macbook Pro de 13 pulgadas.(1) Viene con una CPU de 8 núcleos que permite un rendimiento óptimo en los flujos de trabajo más exigentes, como fotografía, programación y edición de video.",
